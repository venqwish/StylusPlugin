...
import com.stylusplugin.parser.StylusParser;
import com.stylusplugin.psi.StylusFile;
...
public class StylusParserDefinition implements ParserDefinition{
    ...
    public static final TokenSet COMMENTS = TokenSet.create(StylusTypes.COMMENT);
